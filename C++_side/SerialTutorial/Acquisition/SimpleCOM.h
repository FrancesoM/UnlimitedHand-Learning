...
//Name for the file and the dataset.
extern char name[NAMELENGTH];
//Variable for stopping the serial read
extern bool acquiring;
//Mutex for sunchronizing threads
extern std::mutex m;
//Variable used to switch from movements
extern int state;
//Byte to send to the uC to switch between states
extern __int8 unsigned sByte;
